...
-- Listage de la structure de table smartshoppingprototype. nom_repas
CREATE TABLE IF NOT EXISTS `nom_repas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table smartshoppingprototype.nom_repas : ~0 rows (environ)
...
CREATE TABLE IF NOT EXISTS `repas` (
  ...
  CONSTRAINT `repas_ibfk_1` FOREIGN KEY (`id_repas`) REFERENCES `nom_repas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table smartshoppingprototype.repas : ~0 rows (environ)
